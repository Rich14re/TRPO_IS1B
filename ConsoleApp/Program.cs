...
namespace ConsoleApp
{
    internal class Program
    {
        ...
        static readonly List<Position> positions = new List<Position>();
        static readonly List<Body> bodies = new List<Body>();
        static readonly List<TypeOfActivity> typeOfActivities = new List<TypeOfActivity>();
        static readonly List<Organisation> organisations = new List<Organisation>();
        static readonly List<Student> students = new List<Student>();
        static readonly List<Division> divisions = new List<Division>();
